...
(defn collection
  [name]
  (str "com.etzhayyim.nist." name))

(def cell-specs {
  :health {:legacy-cell "com-etzhayyim-apps-nist-health"
     :phase :event
  ...
  :get {:legacy-cell "com-etzhayyim-apps-nist-coverage-get"
     :phase :event
     :murakumo-node "reuben"
  ...
  :domain-knowledge {:legacy-cell "domain-knowledge"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :csfassessment {:legacy-cell "com-etzhayyim-apps-nist-csfAssessment"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "csfassessment")]
     :required-gates common-gates
     :trigger "manifest cell csfassessment"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :evaluation {:legacy-cell "com-etzhayyim-apps-completer-evaluation"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "evaluation")]
     :required-gates common-gates
     :trigger "manifest cell evaluation"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
